...
ServerEvents.recipes((event) => {
      ...
      if (global.loaded.IE_Loaded) {
        ...
        event.forEachRecipe(
          ...
          (recipe) => {
            ...
            if (result.has("base_ingredient")) {
              if (
                global.ingredientCheck(ingot, result.get("base_ingredient"))
              ) {
                count++;
              }
        ...
        if (count == 0) {
          ...
          event
            .custom(recipe)
            .id(
              `kubejs:immersiveengineering/metalpress/unpacking/block_${material}`
            );
          ingotCount.ie++;
        }
      }
      if (global.loaded.Thermal_Loaded) {
        ...
        if (count == 0) {
          event
            ...
            .id(
              `kubejs:thermal/machines/press/unpacking/press_${material}_unpacking`
            );
          ingotCount.thermal++;
        }
      }
      ...
      if (global.loaded.IE_Loaded) {
        ...
        if (count == 0) {
          event
            ...
            .id(
              `kubejs:immersiveengineering/metalpress/packing3x3/${material}_nugget`
            );
          ingotCount.ie++;
        }
      }
      if (global.loaded.Thermal_Loaded) {
        ...
        if (count == 0) {
          event
            ...
            .id(
              `kubejs:thermal/machines/press/packing3x3/press_${material}_nugget_packing`
            );
          ingotCount.thermal++;
        }
      }
  ...
  if (global.devLogging) {
    console.log(
      `Added Ingot Recipes - IE: ${ingotCount.ie}, Thermal: ${ingotCount.thermal}`
    );
