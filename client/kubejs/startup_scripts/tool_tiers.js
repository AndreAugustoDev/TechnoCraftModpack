...
const $AIOTBotaniaTiers = Java.loadClass(
  "de.melanx.aiotbotania.items.ItemTiers"
);
// ae2
const $FluixToolType = Java.loadClass("appeng.items.tools.fluix.FluixToolType");
const $QuartzToolType = Java.loadClass(
  "appeng.items.tools.quartz.QuartzToolType"
);
// blue skies
